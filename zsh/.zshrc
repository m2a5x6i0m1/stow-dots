...
# ---- Syntax highlighting ----
zinit light zsh-users/zsh-syntax-highlighting # Must be invoked after all zle -N calls and compinit (compinit calls zle -N under the hood)
# -----------------------------
...
# ---- aliases ----
alias ls='eza -1 --icons=auto --color=auto --group-directories-first'
alias ll='eza -la --git --icons=auto --color=auto --group-directories-first'
alias l='eza -l --git --icons=auto --color=auto --group-directories-first'
alias ex='eza --tree --color=always --group-directories-first | bat'
