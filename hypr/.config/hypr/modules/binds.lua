...
-- local key = "A"
-- local cmd = "uwsm app -- localsend_app"
-- local keys = {}
--
-- hl.bind(main_mod .. " + " .. key, hl.dsp.exec_cmd(cmd))
...
hl.bind(main_mod .. " + SHIFT + DELETE", hl.dsp.exec_cmd("~/.config/hypr/_refactor/scripts/power-menu.sh"))
